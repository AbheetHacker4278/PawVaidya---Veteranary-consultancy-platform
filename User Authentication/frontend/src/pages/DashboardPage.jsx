...
const DashboardPage = () => {
  ...
  return (
    ...
    >
		<h2 className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-orange-500 to-pink-600 text-transparent bg-clip-text'>
			Dashboard
		</h2>
        ...
        <div className='space-y-6'>
			...
			>
				<motion.button
					...
					className='w-full py-3 px-4 bg-gradient-to-r from-orange-500 to-pink-600 text-white 
